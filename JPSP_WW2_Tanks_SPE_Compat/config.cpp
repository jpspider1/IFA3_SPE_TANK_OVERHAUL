...
class CfgPatches
{
	...
	{
		units[] = {"JPSP_Panzer2F", "JPSP_Panzer2F_DAK"};
        vehicles[] = {};
		weapons[] = {"JPSP_KwK_30_L55","JPSP_KwK_38_L55","JPSP_M3_90mm_base"};
		requiredVersion = 1;
		requiredAddons[] = {"JPSP_IFA_SPE_Tank_Overhaul","FA_WW2_Tanks"};
		ammo[] = {"JPSP_SprGr_Flak_38","JPSP_PzGr_Flak_38_AP_T","JPSP_PzGr40_Flak_38_APCR_T","JPSP_90mm_M82_APCBC","JPSP_90mm_M82_APCBC_penetrator"};
...
class CfgVehicles
{
	...
	class FA_Pz38t_BASE: Tank_F
	{
		...
		soundEngineOffExt[] = {"\JPSP_WW2_Tanks_SPE_Compat\Sounds\Panzer_II_engine_stop_EXT_01.ogg","db2",1,250};
		soundEngineOnInt[] = {"\JPSP_WW2_Tanks_SPE_Compat\Sounds\Panzer_II_engine_start_INT_01.ogg","db2",1};
		soundEngineOffInt[] = {"\JPSP_WW2_Tanks_SPE_Compat\Sounds\Panzer_II_engine_stop_INT_01.ogg","db2",1};
        class Sounds
        {
	...
	class FA_Panzer2_Base: Tank_F
	{
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				SPE_SightAmmoTypes[] = {"JPSP_10x_PzGr40_Flak_38_APCR_T","JPSP_10x_PzGr_Flak_38_AP_T","JPSP_10x_SprGr_Flak_38","SPE_150rnd_MG34"};
				...
				class OpticsIn
				{
					...
					class Near
					{
						opticsDisplayName = "x2.5";
						useModelOptics = 1;
						gunnerOpticsModel = "\A3\weapons_f\reticle\optics_empty"; // Changed to be empty
						gunnerOpticsEffect[] = {"TankGunnerOptics2","OpticsBlur1","OpticsCHAbera1"};
						initAngleX = 0;
						minAngleX = -30;
						maxAngleX = 30;
	...
	class JPSP_Panzer2F_Base: FA_Panzer2_Base
	{
		driverOpticsModel = "\WW2\SPE_Assets_m\Vehicles\Optics_m\SPE_Generic_Periscope.p3d"; // SPE
		displayName = "PzKpfw II F (BASE)";
		armor = 250; //250 original
		armorStructural = 50; //1
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				gunBeg = "usti hlavne";
				gunEnd = "konec hlavne";
				weapons[] = {"JPSP_KwK_38_L55","SPE_MG34_coax"};
				magazines[] = {
					"JPSP_10x_PzGr40_Flak_38_APCR_T","JPSP_10x_PzGr40_Flak_38_APCR_T",
					"JPSP_10x_PzGr_Flak_38_AP_T","JPSP_10x_PzGr_Flak_38_AP_T","JPSP_10x_PzGr_Flak_38_AP_T","JPSP_10x_PzGr_Flak_38_AP_T","JPSP_10x_PzGr_Flak_38_AP_T","JPSP_10x_PzGr_Flak_38_AP_T",
					"JPSP_10x_SprGr_Flak_38","JPSP_10x_SprGr_Flak_38","JPSP_10x_SprGr_Flak_38","JPSP_10x_SprGr_Flak_38","JPSP_10x_SprGr_Flak_38",
				...
				class OpticsIn
				{
					...
					class Near
					{
						opticsDisplayName = "x2.5";
						useModelOptics = 1;
						gunnerOpticsModel = "\A3\weapons_f\reticle\optics_empty"; // Changed to empty
						gunnerOpticsEffect[] = {"TankGunnerOptics2","OpticsBlur1","OpticsCHAbera1"};
						initAngleX = 0;
						minAngleX = -30;
						maxAngleX = 30;
	...
	class JPSP_Panzer2F: JPSP_Panzer2F_Base
	{
		...
		scopeCurator = 2;
		author = "Jpspider";
		displayName = "PzKpfw II F";
		editorPreview = "\FA_WW2_Tanks\ui\previews\pre_pz2_ca.jpg";
		textureList[] = {"Grey",1};
	};
	...
	{
		armor = 310; //310
		armorStructural = 50; //2.2
		driverOpticsModel = "\WW2\SPE_Assets_m\Vehicles\Optics_m\SPE_Generic_Periscope.p3d"; // SPE
		//sounds
		soundEngineOnExt[] = {"\JPSP_WW2_Tanks_SPE_Compat\Sounds\valentine\Valentine_engine_start_ext_01.ogg","db2",1.2,250};
		soundEngineOffExt[] = {"\JPSP_WW2_Tanks_SPE_Compat\Sounds\valentine\Valentine_engine_stop_ext_01.ogg","db2",1,250};
		soundEngineOnInt[] = {"\JPSP_WW2_Tanks_SPE_Compat\Sounds\valentine\Valentine_engine_start_int_01.ogg","db2",1};
		soundEngineOffInt[] = {"\JPSP_WW2_Tanks_SPE_Compat\Sounds\valentine\Valentine_engine_stop_int_01.ogg","db2",1};
        class Sounds
        {
       
			soundSetsExt[] = {"Valentine_Engine_RMP0_EXT_SoundSet","Valentine_Engine_RMP1_EXT_SoundSet","Valentine_Engine_RMP2_EXT_SoundSet","Valentine_Engine_RMP3_EXT_SoundSet","Valentine_Engine_RMP4_EXT_SoundSet",
			"SPE_tank_sherman_ext_tracks_slow_soundSet","SPE_tank_sherman_ext_tracks_mid_soundSet","SPE_tank_sherman_ext_tracks_fast_soundSet","SPE_tank_sherman_ext_rumble_soundSet","SPE_tank_ext_internalFire_soundSet","SPE_trackSurfaceSound_ext_soft_soundSet","SPE_trackSurfaceSound_ext_hard_soundSet","SPE_trackSurfaceSound_ext_sand_soundSet","SPE_tank_Ext_rain_light_soundSet","SPE_tank_Ext_rain_hard_soundSet","Tank_General_Collision_SoundSet"};
			
			soundSetsInt[] = {"Valentine_Engine_RMP0_INT_SoundSet","Valentine_Engine_RMP1_INT_SoundSet","Valentine_Engine_RMP2_INT_SoundSet","Valentine_Engine_RMP3_INT_SoundSet","Valentine_Engine_RMP4_INT_SoundSet",
			"SPE_tank_sherman_ext_tracks_slow_soundSet","SPE_tank_sherman_ext_tracks_mid_soundSet","SPE_tank_sherman_ext_tracks_fast_soundSet","SPE_tank_sherman_ext_rumble_soundSet","SPE_tank_int_internalFire_soundSet","SPE_int_breakingStrain_soundSet","SPE_tankRattling_1_soundSet","SPE_int_vehicleStrainTankHeavy_soundSet","SPE_curveStress_1_soundShader","SPE_tank_Int_rain_light_soundSet","SPE_tank_Int_rain_hard_soundSet","Tank_General_Collision_Int_SoundSet","SPE_cscReload_Int_shellEject_genericCannon_SoundSet","SPE_cscReload_Int_movementLoop_genericCannon_SoundSet","SPE_cscReload_Int_breechOpen_genericCannon_SoundSet","SPE_cscReload_Int_shellLoading_genericCannon_SoundSet"};
		};
		class EventHandlers: EventHandlers
		{
			class SPE_AntiFlip
		...
		class Turrets: Turrets
		{
			class MainTurret: MainTurret
			{
				...
				gunBeg = "usti hlavne";
				gunEnd = "konec hlavne";
				weapons[] = {"JPSP_QOF_2","FA_Besa_coax_T"};
				magazines[] = {"SPE_50x_Shell_37L57_M51_APC","LIB_225Rnd_Besa","LIB_225Rnd_Besa","LIB_225Rnd_Besa","LIB_225Rnd_Besa","LIB_225Rnd_Besa","LIB_225Rnd_Besa","LIB_225Rnd_Besa"};
				memoryPointGun = "usti hlavne1";
				selectionFireAnim = "zasleh1";
		...
		class AnimationSources: AnimationSources
		{
			...
			{
				source = "ammorandom";
				weapon = "FA_Besa_coax_T";
			};
			class HideFuelTank
			{
				displayName = "Hide Fuel Tank";
				author = "Luca";
				source = "Proxy";
				initPhase = 1;
				mass = 0;
